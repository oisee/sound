...
if __name__ == "__main__":
    input_file = "./in_wav/tsv/sliding_reduced.tsv"  # Processed TSV file
    # input_file = "./in_wav/tsv/other_reduced.tsv"  # Processed TSV file
    # output_file = "./in_wav/tsv/other_smoothed.tsv"  # Output smoothed TSV file
    output_file = "./in_wav/tsv/sliding_reduced_smoothed.tsv"  # Output smoothed TSV file
